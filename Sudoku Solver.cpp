...
//To find the next empty row and column
...
//To make a copy of array if solveSudoku9x9 is TRUE
...
//To find all the numbers that can be placed in a cell
...
//To check whether sudoko can be solved or not
